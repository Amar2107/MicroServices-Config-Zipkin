...
import com.dailycodebuffer.departmentservice.controller.DepartmentService;
...
public class DepartmentController {
	...
	public Department saveDepartment(@RequestBody Department department) {
		log.info("inside DepartmentController's saveDepartment");
		return departmentService.saveDepartment(department);
	}
	
	@GetMapping("/{id}")
	public Department findByDepartmentId(@PathVariable("id")Long departmentId){
		log.info("inside DepartmentController's findByDepartmentId");
